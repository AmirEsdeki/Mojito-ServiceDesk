...
namespace Mojito.ServiceDesk.Infrastructure.Services.TicketIssueService
{
        ...
        : BaseService<TicketIssue, PostTicketIssueDTO, PutTicketIssueDTO, GetTicketIssueDTO, TicketIssuesFilterParams>, ITicketIssueService
    {
        ...
        #region CRUD
        public override async Task<PaginatedList<GetTicketIssueDTO>> GetAllAsync(TicketIssuesFilterParams arg)
        {
            try
            {
